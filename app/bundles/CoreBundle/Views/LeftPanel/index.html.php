...
<div class="sidebar-header">
    ...
    <a class="mautic-brand<?php echo (!empty($extraMenu)) ? ' pull-left pl-0 pr-0' : ''; ?>" href="#">
        ...
        <image xlink:href="/media/images/logo_f.jpg" width="120" height="120" y="0" x="0"></image>     
...
<!--<image xlink:href="/media/images/logo.jpg" width="120" height="120" y="0" x="0"></image> -->
          <text style="fill: #fff; stroke: #000000;  font-size: 65px;margin-top: 40px;font-weight: 900;" x="-320" y="55">
                  LinkALL
        </text>
<!--          <g>
